...
import { Activity, TrendingUp, TrendingDown, Calculator, Shield, Lightbulb, Brain, FileText, X, Upload, RotateCcw, Loader2, Save } from "lucide-react";
import { u as useAuth, s as supabase } from "./router-BjAoc50q.js";
import { a as calculatePips, e as calculateRR, c as calculatePnl, b as detectOutcome, P as POPULAR_PAIRS, f as formatCurrency, S as STRATEGIES, E as EMOTIONS, C as COMMON_MISTAKES, d as determineResult } from "./trade-utils-DspPNmfQ.js";
...
const initialForm = {
  ...
  mistakes: [],
  notes: "",
  openedAt: (/* @__PURE__ */ new Date()).toISOString().slice(0, 16)
};
function AddTradePage() {
  ...
  }, [form.entry, form.exit, form.sl, form.tp, form.lotSize, form.pair, form.side]);
  const effectivePnl = useMemo(() => {
    ...
    return calc.autoPnl;
  }, [form.pnlOverride, form.pnl, form.exit, calc.autoPnl]);
  useEffect(() => {
    return () => {
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "px-4 pt-6 sm:px-6 lg:px-8 lg:pt-10", children: [
    /* @__PURE__ */ jsxs("header", { className: "mx-auto max-w-6xl", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-extrabold tracking-tight sm:text-3xl", style: {
        letterSpacing: "-0.025em"
      }, children: "New Trade" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Log every detail. P/L is auto-calculated from your entry, exit and lot size." })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto mt-6 grid max-w-6xl gap-5 lg:grid-cols-[1fr_320px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs(Section, { title: "Trade Details", icon: Activity, description: "Pair, direction, lot size, prices", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Pair", children: /* @__PURE__ */ jsxs(Select, { value: form.pair, onValueChange: (v) => setForm((f) => ({
              ...f,
              pair: v
            })), children: [
            ...
            /* @__PURE__ */ jsx(Field, { label: "Direction", children: /* @__PURE__ */ jsx("div", { className: "flex h-11 items-center rounded-xl bg-input p-1", children: ["buy", "sell"].map((s) => /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setForm((f) => ({
              ...f,
              side: s
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Lot size", children: /* @__PURE__ */ jsx(NumInput, { value: form.lotSize, onChange: (v) => setForm((f) => ({
              ...f,
              lotSize: v
            })), placeholder: "0.10" }) }),
            /* @__PURE__ */ jsx(Field, { label: "Date & time", children: /* @__PURE__ */ jsx(Input, { type: "datetime-local", value: form.openedAt, onChange: (e) => setForm((f) => ({
              ...f,
              openedAt: e.target.value
            })), className: "h-11 rounded-xl bg-input border-border" }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Entry price", children: /* @__PURE__ */ jsx(NumInput, { value: form.entry, onChange: (v) => setForm((f) => ({
              ...f,
              entry: v
            })), placeholder: "1.08500" }) }),
            /* @__PURE__ */ jsx(Field, { label: "Exit price", children: /* @__PURE__ */ jsx(NumInput, { value: form.exit, onChange: (v) => setForm((f) => ({
              ...f,
              exit: v
            })), placeholder: "1.08750" }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-input/40 p-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground", children: [
                /* @__PURE__ */ jsx(Checkbox, { checked: form.pnlOverride, onCheckedChange: (c) => setForm((f) => ({
                  ...f,
                  pnlOverride: !!c,
                  pnl: c ? calc.autoPnl ? String(calc.autoPnl) : "" : ""
                })), className: "h-3.5 w-3.5" }),
                "Override"
              ] })
            ] }),
            form.pnlOverride ? /* @__PURE__ */ jsxs("div", { className: "mt-2", children: [
              /* @__PURE__ */ jsx(NumInput, { value: form.pnl, onChange: (v) => setForm((f) => ({
                ...f,
                pnl: v
        ...
        /* @__PURE__ */ jsx(Section, { title: "Risk Management", icon: Shield, description: "Stops, targets, R:R and exposure", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsx(Field, { label: "Stop loss", children: /* @__PURE__ */ jsx(NumInput, { value: form.sl, onChange: (v) => setForm((f) => ({
            ...f,
            sl: v
          })), placeholder: "1.08300" }) }),
          /* @__PURE__ */ jsx(Field, { label: "Take profit", children: /* @__PURE__ */ jsx(NumInput, { value: form.tp, onChange: (v) => setForm((f) => ({
            ...f,
            tp: v
          })), placeholder: "1.09000" }) }),
          /* @__PURE__ */ jsx(Field, { label: "Risk %", children: /* @__PURE__ */ jsx(NumInput, { value: form.riskPercent, onChange: (v) => setForm((f) => ({
            ...f,
            riskPercent: v
          })), placeholder: "1.0" }) }),
        ...
        /* @__PURE__ */ jsxs(Section, { title: "Strategy", icon: Lightbulb, description: "What was the setup and context?", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Strategy", children: /* @__PURE__ */ jsxs(Select, { value: form.strategy, onValueChange: (v) => setForm((f) => ({
              ...f,
              strategy: v
            })), children: [
            ...
            /* @__PURE__ */ jsx(Field, { label: "Session", children: /* @__PURE__ */ jsxs(Select, { value: form.session, onValueChange: (v) => setForm((f) => ({
              ...f,
              session: v
            })), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { className: "h-11 rounded-xl bg-input border-border", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
          ...
          /* @__PURE__ */ jsx(Field, { label: "Confidence (1–5)", children: /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setForm((f) => ({
            ...f,
            confidence: n
        ...
        /* @__PURE__ */ jsxs(Section, { title: "Psychology", icon: Brain, description: "How did you feel before and after?", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(Field, { label: "Emotion before", children: /* @__PURE__ */ jsxs(Select, { value: form.emotionBefore, onValueChange: (v) => setForm((f) => ({
              ...f,
              emotionBefore: v
            })), children: [
            ...
            /* @__PURE__ */ jsx(Field, { label: "Emotion after", children: /* @__PURE__ */ jsxs(Select, { value: form.emotionAfter, onValueChange: (v) => setForm((f) => ({
              ...f,
              emotionAfter: v
            })), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { className: "h-11 rounded-xl bg-input border-border", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "—" }) }),
        ...
        /* @__PURE__ */ jsxs(Section, { title: "Notes & Screenshot", icon: FileText, description: "Why this trade? What did you learn?", children: [
          /* @__PURE__ */ jsx(Field, { label: "Notes", children: /* @__PURE__ */ jsx(Textarea, { value: form.notes, onChange: (e) => setForm((f) => ({
            ...f,
      ...
      /* @__PURE__ */ jsx("aside", { className: "hidden lg:block", children: /* @__PURE__ */ jsxs("div", { className: "sticky top-6 space-y-4", children: [
        /* @__PURE__ */ jsx(SummaryStrip, { pair: form.pair, side: form.side, pips: calc.pips, rr: calc.rr, pnl: effectivePnl, outcome: calc.outcome, hasExit: !!form.exit, vertical: true }),
        /* @__PURE__ */ jsxs("div", { className: "surface-card rounded-2xl p-4", children: [
          /* @__PURE__ */ jsx("p", { className: "text-[11px] font-semibold uppercase tracking-wider text-muted-foreground", children: "Quick reference" }),
          /* @__PURE__ */ jsxs("ul", { className: "mt-3 space-y-1.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsx("li", { children: "• Pip value uses standard $10/lot model." }),
            /* @__PURE__ */ jsxs("li", { children: [
              "• Toggle ",
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground", children: "Override" }),
              " to type the exact broker P/L."
            ] }),
            /* @__PURE__ */ jsx("li", { children: "• Win/Loss is auto-detected from entry vs. exit." }),
            /* @__PURE__ */ jsx("li", { children: "• Leave exit empty to log an open trade." })
          ] })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "sticky bottom-24 mt-6 lg:bottom-6", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-6xl gap-3 pb-2", children: [
      /* @__PURE__ */ jsxs(Button, { type: "button", variant: "outline", onClick: reset, className: "h-12 flex-1 rounded-xl border-border bg-surface", children: [
